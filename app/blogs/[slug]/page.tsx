...
const page = async ({ params } :any) => {
  ...
  return (
    <main className="flex h-full m-4 flex-col items-center justify-center bg-white ">
      <section className="flex w-full   max-w-4xl flex-col items-center border border-mainbrown rounded-lg justify-center bg-white p-4 shadow-mainbrown shadow-md md:p-8">
